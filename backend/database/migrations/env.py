...
# Ensure project directories are on sys.path so package imports work when Alembic runs
import sys
here = os.path.abspath(os.path.dirname(__file__))
# backend directory (so `api` imports work) and repo root (so `backend` imports work)
